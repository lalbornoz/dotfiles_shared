...
call AddNMapping("File", "Go to end of previous word", 'Go to end of previous word', '', '<Ctrl><Alt><Left>', 'ge')
call AddNMapping("File", "Go to end of previous WORD", 'Go to end of previous WORD', '', '<Ctrl><Alt><Shift><Left>', 'gE')
call AddNMapping("File", "Go to end of word", 'Go to end of word', '', '<Ctrl><Alt><Right>', 'e')
call AddNMapping("File", "Go to end of WORD", 'Go to end of WORD', '', '<Ctrl><Alt><Shift><Right>', 'E')
call AddSeparator("File")
...
call AddSeparator("File")
call AddNMapping("File", "Go to first line", 'Go to first line', '', '<Ctrl><Alt><Up>', 'gg')
call AddNMapping("File", "Go to top of window", 'Go to top of window', '', '<Ctrl><Alt><Shift><Up>', 'H')
call AddNMapping("File", "Go to last line", 'Go to last line', '', '<Ctrl><Alt><Down>', 'G')
call AddNMapping("File", "Go to bottom of window", 'Go to bottom of window', '', '<Ctrl><Alt><Shift><Down>', 'L')
call AddSeparator("File")
