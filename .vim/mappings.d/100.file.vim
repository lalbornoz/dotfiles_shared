...
call AddMapping("File", "Toggle spectre", "Toggle spectre", "<silent>", '<Ctrl><F10>', '<Cmd>lua require("spectre").toggle()<CR>')
call AddMapping("File", "Spectre search word", "Spectre search word", "<silent>", '<Ctrl><S-F10>', '<Cmd>lua require("spectre").open_visual({select_word=true})<CR>')
call AddMapping("File", "Spectre search in file", "Spectre search in file", "<silent>", '<Alt><S-F10>', '<Cmd>lua require("spectre").open_file_search({select_word=true})<CR>')
else
