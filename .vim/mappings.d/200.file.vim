...
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "&Open workspace...", ":WorkspacesOpen ")
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "--", "")
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "&Add workspace...", ":WorkspacesAdd ")
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "&Add workspace from directory...", ":WorkspacesAddDir")
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "&Remove workspace...", ":WorkspacesRemove ")
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "&Remove workspace from directory...", ":WorkspacesRemoveDir ")
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "Re&name workspace...", ":WorkspacesRename ")
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "&Synchronise workspaces...", ":WorkspacesSyncDirs")
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "--", "")
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "&List workspaces...", ":WorkspacesList")
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "&List workspace directories...", ":WorkspacesListDirs")
call roarie_commands#AddSubMenuItem("workspaces_submenu", " ", "Workspaces &picker...", ":Telescope workspaces")
endif
call roarie_commands#AddSeparator("&File")
if has('nvim')
