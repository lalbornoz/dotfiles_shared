...
call roarie_commands#AddMapping("&Motion", "motion_WORD_end", "Go to &end of WORD", "Go to end of WORD", '', '<M-C-S-Right>', 'E')
call roarie_commands#AddSeparator("&Motion")
...
call roarie_commands#AddSeparator("&Motion")
call roarie_commands#AddMapping("&Motion", "motion_line_first", "Go to &first line", "Go to first line", '', '<M-C-Up>', 'gg')
call roarie_commands#AddMapping("&Motion", "motion_win", "Go to &top of window", "Go to top of window", '', '<M-C-S-Up>', 'H')
call roarie_commands#AddMapping("&Motion", "motion_line_last", "Go to &last line", "Go to last line", '', '<M-C-Down>', 'G')
call roarie_commands#AddMapping("&Motion", "motion_win", "Go to &bottom of window", "Go to bottom of window", '', '<M-C-S-Down>', 'L')
call roarie_commands#AddSeparator("&Motion")
call roarie_commands#AddMapping("&Motion", "motion_cursor_prev", "Go to previous &cursor position", "Go to previous cursor position in jump list", '', '<S-Left>', '<C-O>')
call roarie_commands#AddMapping("&Motion", "motion_cursor_next", "Go to next &cursor position", "Go to next cursor position in jump list", '', '<S-Right>', '<C-I>')
