...
call AddMapping("LSP", "Search workspace symbols...", "Search the workspace symbols for all servers and navigate using quickpick", '<silent>', '<Alt><S-F3>', ':<C-U>LspWorkspaceSymbolSearch<CR>')
call AddSeparator("LSP")
...
call AddMapping("LSP", "Go to previous diagnostic", "Go to previous diagnostic in file", '<silent>', '<Alt><S-F5>', ':<C-U>LspPreviousDiagnostic<CR>')
