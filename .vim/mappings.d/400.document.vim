...
call roarie_commands#AddMapping("&Document", "workspace_symbols", "Workspace &symbols...", "Telescope lsp_dynamic_workspace_symbols...", "<silent>", '<S-F3>', '<Cmd>Telescope lsp_dynamic_workspace_symbols<CR>', "<fnalias>", "")
...
call roarie_commands#AddSeparator("&Document")
call roarie_commands#AddMapping("&Document", "document_diagnostics", "Dia&gnostics...", "Telescope diagnostics...", "<silent>", '<M-S-F3>', ':<C-U>Telescope diagnostics<CR>', "<fnalias>", "ﱥ")
...
if has('nvim')
call roarie_commands#AddMapping("&Document", "search_man_pages", "Search &man_pages...", "Telescope man_pages...", '<silent>', '<M-S-F4>', ':<C-U>lua require("telescope.builtin").man_pages({sections = {"ALL"}})<CR>', "<fnalias>", "ﯳ")
endif
if !has('nvim')
call roarie_commands#AddSeparator("&Document")
