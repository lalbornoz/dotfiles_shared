...
call roarie_commands#AddSubMenuItem("build_submenu", " ", "&Build", ":BuildMe")
call roarie_commands#AddSubMenuItem("build_submenu", " ", "Build with &arguments...", ":BuildMe ")
call roarie_commands#AddSubMenuItem("build_submenu", " ", "&Stop build job", ":BuildMeStop")
...
call roarie_commands#AddSubMenuItem("build_submenu", " ", "&Stop run job", ":RunMeStop")
call roarie_commands#AddSubMenuItem("build_submenu", " ", "Set &default run arguments...", ":RunMeEditArgs ")
call roarie_commands#AddSubMenuItem("build_submenu", " ", "Current:                    ", ":RunMeEditArgs ", 'return "Current: " .. (require("buildme").getargsrun() or "")', 'return ":RunMeEditArgs " .. (require("buildme").getargsrun() or "")')
...
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "&Start debugging session", ":GdbStart gdb -q ./a.out")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "&Start debugging session with LLDB", ":GdbStartLLDB lldb ./a.out")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "Start &Python debugging session", ":GdbStartPDB python -m pdb main.py")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "Start BAS&H debugging session", ":GdbStartBashDB bashdb main.sh")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "Start debugging session with &rr replay", ":GdbStartRR")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "--", "")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "Toggle &breakpoint in the cursor line", ":GdbBreakpointToggle")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "Continue e&xecution until a given line", ":GdbUntil")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "&Continue execution", ":GdbContinue")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "Step &over the next statement", ":GdbNext")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "Step &into the next statement", ":GdbStep")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "Step ou&t the current frame", ":GdbFinish")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "--", "")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "Navigate one frame &up", ":GdbFrameUp")
call roarie_commands#AddSubMenuItem("gdb_submenu", " ", "Navigate one frame &down", ":GdbFrameDown")
...
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Re&apply commits on top of another base tip", ":Git rebase")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Git &add with work tree file, Git checkout from index or blob", ":Gwrite")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Show commit &logs", ":Git log")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "--", "")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Bring up stage&d and working tree version of file", ":Gdiffsplit")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Bring up stage&d and working tree version of file (vertical)", ":Gvdiffsplit")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Show &changes between commits, commit and working tree, etc", ":Git diff")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Show &changes using common diff tools", ":Git difftool")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "--", "")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Git &rm current file and delete buffer", ":GDelete")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Git &rm current file without deleting buffer", ":GRemove")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Git &mv current file and delete buffer", ":GMove")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Git &mv current file without deleting buffer", ":GRename")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "--", "")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Show &what revision and author last modified each line of file", ":Git blame")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Git &grep (Quickfix window)", ":Ggrep")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Git &grep (location list)", ":Glgrep")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Git checkou&t on and into current buffer", ":Gread")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "Run merge con&flict resolution tools to resolve merge conflicts", ":Git mergetool")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "--", "")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "&View blob, tree, commit, or tag", ":Gedit")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "&Split work tree file or revision", ":Gsplit")
call roarie_commands#AddSubMenuItem("git_submenu", " ", "&Split work tree file or revision (vertical)", ":Gvsplit")
if has('nvim')
