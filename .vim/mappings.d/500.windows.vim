...
call roarie_menu#AddMapping("Windows", "Create new window", "Create new window", '<silent>', '<F7>', ':<C-U>new<CR>')
call roarie_menu#AddMapping("<Fn>", "Create new window", "Create new window", '<silent>', '<F7>', ':<C-U>new<CR>', 1)
call roarie_menu#AddMapping("Windows", "Create new vertically split window", "Create new vertically split window", '<silent>', '<S-F7>', ':<C-U>vnew<CR>')
call roarie_menu#AddMapping("<Fn>", "Create new vertically split window", "Create new vertically split window", '<silent>', '<S-F7>', ':<C-U>vnew<CR>', 1)
call roarie_menu#AddMapping("Windows", "Close current window", "Close current window", '<silent>', '<S-F8>', ':<C-U>close<CR>')
call roarie_menu#AddMapping("<Fn>", "Close current window", "Close current window", '<silent>', '<S-F8>', ':<C-U>close<CR>', 1)
...
call roarie_menu#AddMapping("Windows", "QuickFix window...", "Toggle the QuickFix window given recognised errors", "<silent>", '<M-F8>', ':<C-U>ToggleQuickFix<CR>')
call roarie_menu#AddMapping("<Fn>", "QuickFix window...", "Toggle the QuickFix window given recognised errors", "<silent>", '<M-F8>', ':<C-U>ToggleQuickFix<CR>', 1)
