...
if has('nvim')
call roarie_commands#AddMapping("&Project", "telescope_man_pages", "Telesc&ope man_pages...", "Telescope man_pages...", '<silent>', '<M-S-F4>', ':<C-U>lua require("telescope.builtin").man_pages({sections = {"ALL"}})<CR>', "<fnalias>")
endif
call roarie_commands#AddSeparator("&Project")
...
call roarie_commands#AddMapping("&Project", "telescope_git_commits", "Telescope git_&commits...", "Telescope git_commits...", '', '<M-S-F6>', ':<C-U>Telescope git_commits<CR>', "<fnalias>")
