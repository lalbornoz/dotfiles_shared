...
call roarie_commands#AddMapping("&Project", "goto_decl", "Go to declaration", "Go to declaration", "<silent>", '<S-F2>', '<Cmd>lua vim.lsp.buf.declaration()<CR>', "<fnalias>")
else
...
call roarie_commands#AddMapping("&Project", "peek_decl", "Peek declaration", "Peek declaration", "<silent>", '<S-F1>', ':<C-U>LspPeekDeclaration<CR>', "<fnalias>")
...
call roarie_commands#AddMapping("&Project", "goto_decl", "Go to declaration", "Go to declaration", "<silent>", '<S-F2>', ':<C-U>LspDeclaration<CR>', "<fnalias>")
endif
...
call roarie_commands#AddMapping("&Project", "find_all_refs", "Find all references", "Find all LSP references", "<silent>", '<M-F3>', ':<C-U>LspReferences<CR>', "<fnalias>")
endif
call roarie_commands#AddSeparator("&Project")
if has('nvim')
...
call roarie_commands#AddMapping("&Project", "code_action", "Code action...", "Code action...", "<silent>", '<S-F4>', '<Cmd>lua vim.lsp.buf.code_action()<CR>', "<fnalias>")
else
