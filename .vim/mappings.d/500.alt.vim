...
call roarie_menu#AddSeparator("<&Alt>")
call roarie_menu#AddMapping("<&Alt>", "telescope_emoji", "Telescope emoji", "Telescope emoji", '<silent>', '<M-e>', ':<C-U>Telescope emoji<CR>')
call roarie_menu#AddMapping("<&Alt>", "telescope_glyph", "Telescope glyph", "Telescope glyph", '<silent>', '<M-g>', ':<C-U>Telescope glyph<CR>')
call roarie_menu#AddSeparator("<&Alt>")
