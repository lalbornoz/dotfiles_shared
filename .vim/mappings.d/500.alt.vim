...
call roarie_commands#AddMapping("<&Alt>", "toggle_foldmethod", "Toggle &foldmethod", "Toggle between foldmethod=marker and foldmethod=indent", '<silent>', '<M-f>', ':<C-U>ToggleFoldMethod<CR>')
...
call roarie_commands#AddMapping("<&Alt>", "set_tw0", "Set &tw=0", "Set textwidth to 0", "<silent>", '<M-W>', ':<C-U>set tw=0<CR>')
...
call roarie_commands#AddMapping("<&Alt>", "reset_syntax", "Reset syntax &highlighting", "Reset syntax highlighting", '<silent>', '<M-y>', ':<C-U>syntax on<CR>')

" vim:filetype=vim noexpandtab sw=8 ts=8 tw=0uuu
