...
call roarie_commands#AddMapping("<&Alt>", "case_invert_word", "&Invert case of word", "Invert case of word under cursor", '<silent>', '<M-c>', 'g~w')
call roarie_commands#AddMapping("<&Alt>", "case_invert_line", "&Invert case of line", "Invert case of line under cursor", '<silent>', '<M-C>', 'g~~')
