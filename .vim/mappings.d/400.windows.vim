...
call AddSeparator("Windows")
call AddMapping("Windows", "Go to previous buffer", "Go to previous edited buffer in buffer list", '<silent>', '<C-[>', ':<C-U>b#<CR>')
call AddMapping("Windows", "Move window to new tab", "Move window to new tab page", '<silent>', '<C-g>', ':<C-U>wincmd T<CR>')
call AddMapping("Windows", "Go to previous tab", "Go to previous tab page w/ wraparound", '<silent>', '<C-h>', ':<C-U>tabprev<CR>')
