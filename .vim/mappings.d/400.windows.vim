...
call AddSeparator("Windows")
call AddMapping("Windows", "Go to previous tab", "Go to previous tab page w/ wraparound", '<silent>', '<Ctrl><Alt><Left>', ':<C-U>tabprev<CR>')
...
call AddMapping("Windows", "Go to next tab page", "Go to next tab page w/ wraparound", '<silent>', '<Ctrl><Alt><Right>', ':<C-U>tabnext<CR>')
...
call AddMapping("Windows", "Move window to new tab", "Move window to new tab page", '<silent>', '<Ctrl><Alt><Up>', ':<C-U>wincmd T<CR>')
call AddMapping("Windows", "Split window", "Split current window in two", '<silent>', '<Ctrl><Alt><Down>', ':<C-U>wincmd s<CR>')
call AddSeparator("Windows")
...
call AddMapping("Windows", "Go to next tab page", "Go to next tab page w/ wraparound", '<silent>', '<C-h>', ':<C-U>tabnext<CR>')
...
call AddTMapping("Windows", "Go to previous tab", "Go to previous tab page w/ wraparound (terminal job mode)", '<silent>', '<C-T><Tab>', '<C-T>:tabprev<CR>')
